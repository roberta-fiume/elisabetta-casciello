window.addEventListener("load", function() {
    ...
    function defineProfileAndPrintResultinHtml() {
        ...
        if (summedAnswers === 14) {
          ...
          returntestResultProfile.innerHTML =  "Siamo sulla buona strada! Le tue abitudini alimentari sono quasi tutte giuste." + " " +  "Ti consiglio di riprendere in considerazione le risposte alle quali hai dato “SI”. Puoi fare di più per te stesso/a.";
